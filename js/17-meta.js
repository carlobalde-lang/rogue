...
const DIFFICULTIES = [
  { id: 'easy',      name: 'FACILE',     label: 'Facile',    scale: 0.70, desc: 'Fog is thinner: fewer and softer enemies, slower timers. Best for learning builds.' },
  { id: 'normal',    name: 'NORMALE',    label: 'Normale',   scale: 1.00, desc: 'The reference balance: the standard pace and threat curve.' },
  { id: 'hard',      name: 'DIFFICILE',  label: 'Difficile', scale: 1.35, desc: 'Thicker hordes, beefier elites, wardens and bosses arrive sooner.' },
  { id: 'nightmare', name: 'INCUBO',     label: 'Incubo',    scale: 1.80, desc: 'Maximum pressure from minute one. For upgraded builds only.' }
];
